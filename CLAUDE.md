...
Some modules have code generated by [Baltic Porter](https://github.com/kubuszok/balticporter),
a Java→Scala 3 porting engine extended with non-Java frontends for TS/JS and Dart.
