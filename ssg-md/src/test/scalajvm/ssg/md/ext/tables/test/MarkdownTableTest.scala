...
final class MarkdownTableTest extends MarkdownTableTestBase {
  ...
  test("test_EmbeddedPipe0Options") {
    ...
    val table  = getTable(
      source,
      formatOptions("", null).toMutable.set(TablesExtension.FORMAT_TABLE_FILL_MISSING_COLUMNS, true).set(TableFormatOptions.FORMAT_TABLE_FILL_MISSING_MIN_COLUMN, Integer.valueOf(0))
    )
//        table.fillMissingColumns(Integer.valueOf(0))
