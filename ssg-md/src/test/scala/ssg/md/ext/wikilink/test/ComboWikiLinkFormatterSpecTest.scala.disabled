...
final class ComboWikiLinkFormatterSpecTest extends FormatterSpecTestSuite {
  ...
  override def defaultOptions:       Nullable[DataHolder]                   = ComboWikiLinkFormatterSpecTest.OPTIONS
...
object ComboWikiLinkFormatterSpecTest {
  ...
  val OPTIONS: DataHolder = new MutableDataSet().set(Parser.EXTENSIONS, Collections.singleton(WikiLinkExtension.create())).set(Parser.LISTS_AUTO_LOOSE, java.lang.Boolean.valueOf(false)).toImmutable()
