  ...
  val OPTIONS_MAP: java.util.Map[String, DataHolder] = {
    ...
    map.put(
      ...
      new MutableDataSet()
        ...
        .set(TablesExtension.FORMAT_TABLE_MIN_SEPARATOR_COLUMN_WIDTH, java.lang.Integer.valueOf(3))
        ...
        .set(TablesExtension.FORMAT_TABLE_MIN_SEPARATOR_DASHES, java.lang.Integer.valueOf(3))
        .set(TablesExtension.FORMAT_TABLE_TRIM_CELL_WHITESPACE, java.lang.Boolean.valueOf(false))
        .set(
