...
object ComboStrikethroughSubscriptSpecTest {
  ...
  val OPTIONS:           DataHolder       =
    new MutableDataSet().set(HtmlRenderer.INDENT_SIZE, java.lang.Integer.valueOf(0)).set(Parser.EXTENSIONS, Collections.singleton(StrikethroughSubscriptExtension.create())).toImmutable()
