...
object TemplateReader {
  ...
  def readEntries(): ju.List[TemplateEntry] = readEntries(Nullable.empty[String], Nullable.empty[TemplateReaderFactory])

  def readEntries(resource: Nullable[String]): ju.List[TemplateEntry] = readEntries(resource, Nullable.empty[TemplateReaderFactory])
  ...
  def readExamplesAsString(): ju.List[String] = readExamplesAsString(Nullable.empty[String], Nullable.empty[TemplateReaderFactory])

  def readExamplesAsString(resource: Nullable[String]): ju.List[String] = readExamplesAsString(resource, Nullable.empty[TemplateReaderFactory])
  ...
  def readSpec(): String = readSpec(Nullable.empty[String])
  ...
  def getSpecInputStream(): InputStream = getSpecInputStream(Nullable.empty[String])
