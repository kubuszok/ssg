...
object ComboPegdownCompatibilitySpecTest {
  ...
  val OPTIONS: DataHolder = new MutableDataSet()
    ...
    .set(HtmlRenderer.INDENT_SIZE, java.lang.Integer.valueOf(2))
  ...
  private val LOCAL_OPTIONS_MAP: ju.Map[String, DataHolder] = {
    ...
    map.put("lists-item-indent", new MutableDataSet().set(Parser.LISTS_ITEM_INDENT, java.lang.Integer.valueOf(2)))
    map.put(
      "blank-line-interrupts-html",
      new MutableDataSet().set(Parser.HTML_BLOCK_DEEP_PARSE_BLANK_LINE_INTERRUPTS, java.lang.Boolean.valueOf(true))
    )
    map.put(
      "lists-no-loose",
      new MutableDataSet()
        ...
        .set(Parser.LISTS_AUTO_LOOSE_ONE_LEVEL_LISTS, java.lang.Boolean.valueOf(false))
        .set(Parser.LISTS_LOOSE_WHEN_PREV_HAS_TRAILING_BLANK_LINE, java.lang.Boolean.valueOf(false))
        .set(Parser.LISTS_LOOSE_WHEN_LAST_ITEM_PREV_HAS_TRAILING_BLANK_LINE, java.lang.Boolean.valueOf(false))
        .set(Parser.LISTS_LOOSE_WHEN_HAS_NON_LIST_CHILDREN, java.lang.Boolean.valueOf(false))
        .set(Parser.LISTS_LOOSE_WHEN_BLANK_LINE_FOLLOWS_ITEM_PARAGRAPH, java.lang.Boolean.valueOf(false))
        .set(Parser.LISTS_LOOSE_WHEN_HAS_LOOSE_SUB_ITEM, java.lang.Boolean.valueOf(false))
        .set(Parser.LISTS_LOOSE_WHEN_HAS_TRAILING_BLANK_LINE, java.lang.Boolean.valueOf(false))
        .set(Parser.LISTS_LOOSE_WHEN_CONTAINS_BLANK_LINE, java.lang.Boolean.valueOf(false))
    )
    map
  }
